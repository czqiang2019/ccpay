<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"../template/default/service/pay-info.html";i:1568043910;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>扫码支付 - <?php echo get_sys('site_name'); ?></title>
    <link href="/static/pay/css/pay.css" rel="stylesheet" media="screen">
...
<script src="/static/pay/js/vue.min.js"></script>
...
<script>
    ...
    $.post("http://<?php echo get_sys('site_api'); ?>/getOrder","orderId="+getQueryString("orderId"),function (data) {
        if (data.code==1){
    ...
    function check() {
        $.post("http://<?php echo get_sys('site_api'); ?>/checkOrder","orderId="+getQueryString("orderId"),function (data) {
            console.log(data);
            if (data.code == 1){

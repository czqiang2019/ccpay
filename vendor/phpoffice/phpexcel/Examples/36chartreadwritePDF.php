...
$rendererLibraryPath = '/php/libraries/Echarts/' . $rendererLibrary;
...
foreach($inputFileNames as $inputFileName) {
	...
	echo date('H:i:s') , " Iterate worksheets looking at the echarts" , EOL;
	foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) {
		...
		if(empty($chartNames)) {
			echo '    There are no echarts in this worksheet' , EOL;
		} else {
			natsort($chartNames);

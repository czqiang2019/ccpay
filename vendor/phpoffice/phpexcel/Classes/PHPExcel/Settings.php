...
class PHPExcel_Settings
{
    ...
    /**
     * Name of the external Library used for rendering echarts
     *	e.g.
     *		jpgraph
     *
     * @var string
    ...
    /**
     * Directory Path to the external Library used for rendering echarts
     *
     * @var string
     */
    ...
    /**
     * Set details of the external library that PHPExcel should use for rendering echarts
     *
    ...
    /**
     * Identify to PHPExcel the external library to use for rendering echarts
     *
     * @param string $libraryName	Internal reference name of the library
     *	e.g. PHPExcel_Settings::CHART_RENDERER_JPGRAPH
     *
    ...
    /**
     * Tell PHPExcel where to find the external library to use for rendering echarts
     *
     * @param string $libraryBaseDir	Directory path to the library's base folder
     * @return	boolean	Success or failure
     */

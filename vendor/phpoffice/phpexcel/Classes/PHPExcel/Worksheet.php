...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    /**
     * Return the count of echarts on this worksheet
     *
     * @return int        The number of echarts
     */
    ...
    /**
     * Return an array of the names of echarts on this worksheet
     *
     * @return string[] The names of echarts
     * @throws PHPExcel_Exception
     */

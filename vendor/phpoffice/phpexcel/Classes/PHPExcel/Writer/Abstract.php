...
{
	/**
	 * Write echarts that are defined in the workbook?
	 * Identifies whether the Writer should write definitions for any echarts that exist in the PHPExcel object;
	 *
	 * @var	boolean
	 */
	...
	/**
	 * Write echarts in workbook?
	 *		If this is true, then the Writer will write definitions for any echarts that exist in the PHPExcel object.
	 *		If false (the default) it will ignore any echarts defined in the PHPExcel object.
	 *
	 * @return	boolean
	 */
	...
	/**
	 * Set write echarts in workbook
	 *		Set to true, to advise the Writer to include any echarts that exist in the PHPExcel object.
	 *		Set to false (the default) to ignore echarts.
	 *

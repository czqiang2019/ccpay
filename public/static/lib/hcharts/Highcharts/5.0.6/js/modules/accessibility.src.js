...
(function(factory) {
    ...
    (function(H) {
        ...
        var win = H.win,
            ...
            typeDescriptionMap = {
                boxplot: ' Box plot echarts are typically used to display groups of statistical data. ' +
                    'Each data point in the chart can have up to 5 values: minimum, lower quartile, median, upper quartile and maximum. ',
                arearange: ' Arearange echarts are line echarts displaying a range between a lower and higher value for each point. ',
                areasplinerange: ' These echarts are line echarts displaying a range between a lower and higher value for each point. ',
                bubble: ' Bubble echarts are scatter echarts where each data point also has a size value. ',
                columnrange: ' Columnrange echarts are column echarts displaying a range between a lower and higher value for each point. ',
                errorbar: ' Errorbar series are used to display the variability of the data. ',
                funnel: ' Funnel echarts are used to display reduction of data in stages. ',
                pyramid: ' Pyramid echarts consist of a single pyramid with item heights corresponding to each point value. ',

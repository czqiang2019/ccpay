 ...
 *****************************************************************************/
/**
 * Extensions for polar echarts. Additionally, much of the geometry required for polar echarts is
...
function polarAnimate(proceed, init) {
	...
	// Specific animation for polar echarts
	if (chart.polar) {
		
		// Enable animation on polar echarts only in SVG. In VML, the scaling is different, plus animation
	...
	// For non-polar echarts, revert to the basic animation
	} else {

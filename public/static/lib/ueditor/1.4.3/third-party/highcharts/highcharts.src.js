 ...
 * of segments in stock echarts, the normalizing logic was extracted in order to
...
/**
 * Non-recursive method to find the lowest user of an array. Math.min raises a maximum
...
SVGRenderer.prototype = {
	 ...
	 * @param {Number} innerR Inner radius like used in donut echarts
	...
	rect: function (x, y, width, height, r, strokeWidth) {
		...
		return wrapper.attr(
				isObject(x) ?
					x :
					// do not crispify when an object is passed in (as in column echarts)
...
if (useCanVG) {
	...
	CanVGController = (function () {
		...
		/**
		 * When downloaded, we are ready to draw deferred echarts.
		 */
...
Axis.prototype = {
	...
	init: function (chart, userOptions) {
		...
		// inverted echarts have reversed xAxes as default
	...
	setTickPositions: function (secondPass) {
		...
		// In column-like echarts, don't cramp in more ticks than there are points (#1943)
		if (axis.pointRange) {
...
Tooltip.prototype = {
	...
	refresh: function (point, mouseEvent) {
		...
		// get the reference point coordinates (pie echarts use tooltipPos)
...
Pointer.prototype = {
	...
	/**
	 * With line type echarts with a single tracker, get the point closest to the mouse.
	...
	pinchTranslateDirection: function (horiz, pinchDown, touches, transform, selectionMarker, clip, lastValidTouch) {
		...
		if (!inverted) { // TODO: implement clipping for inverted echarts
...
Chart.prototype = {
	...
	destroy: function () {
		...
		// Delete the chart from echarts lookup array
...
Series.prototype = {
	...
	processData: function (force) {
		...
		for (i = processedXData.length - 1; i >= 0; i--) {
			...
			// navigation in Stock echarts (#725) and width calculation of columns (#1900)
	 ...
	 * track mouse events on the graph or points. For the line type echarts
...
var ColumnSeries = extendClass(Series, {
	...
	getColumnMetrics: function () {
		...
		var categoryWidth = mathMin(
			...
			pointWidth = pick(optionPointWidth, pointOffsetWidth - 2 * pointPadding), // exact point width, used in polar echarts
